...
private:
	...
	NumberEdit *m_pctrlXMin, *m_pctrlXMax, *m_pctrlXOrigin,*m_pctrlXUnit;
	NumberEdit *m_pctrlYMin, *m_pctrlYMax, *m_pctrlYOrigin,*m_pctrlYUnit;
	...
	NumberEdit *m_pctrlXMinorUnit, *m_pctrlYMinorUnit;
