...
void AFoilGridDlg::SetupLayout()
{
	...
	m_pctrlXMinUnit = new NumberEdit;
	m_pctrlYMinUnit = new NumberEdit;
	m_pctrlXUnit->setAutomaticPrecision(3);
	m_pctrlYUnit->setAutomaticPrecision(3);
	m_pctrlXMinUnit->setAutomaticPrecision(3);
	m_pctrlYMinUnit->setAutomaticPrecision(3);
