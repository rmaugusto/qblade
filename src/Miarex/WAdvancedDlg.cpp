...
void WAdvancedDlg::SetupLayout()
{
	...
	m_pctrlInterNodes   = new NumberEdit();
	m_pctrlRelax        = new NumberEdit(NumberEdit::Standard, 1);
	m_pctrlRelax->setValue(20);
	m_pctrlAlphaPrec    = new NumberEdit(NumberEdit::Standard, 4);
	m_pctrlAlphaPrec->setValue(0.01);
	m_pctrlMinPanelSize = new NumberEdit(NumberEdit::Standard, 2);
	m_pctrlMinPanelSize->setValue(1);
	m_pctrlNStation     = new NumberEdit(NumberEdit::Standard, 0);
	m_pctrlNStation->setValue(20);
	m_pctrlIterMax      = new NumberEdit(NumberEdit::Standard, 0);
	m_pctrlIterMax->setValue(100);
	m_pctrlMaxWakeIter  = new NumberEdit(NumberEdit::Standard, 0);
	m_pctrlMaxWakeIter->setValue(5);
	m_pctrlCoreSize     = new NumberEdit(NumberEdit::Standard, 4);
	m_pctrlCoreSize->setValue(0.0001);
	m_pctrlVortexPos    = new NumberEdit(NumberEdit::Standard, 2);
	m_pctrlVortexPos->setValue(25);
	m_pctrlControlPos   = new NumberEdit(NumberEdit::Standard, 2);
	m_pctrlControlPos->setValue(75);
