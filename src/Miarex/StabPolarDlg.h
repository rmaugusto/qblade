...
private:
	...
	NumberEdit *m_pctrlDensity;
	NumberEdit *m_pctrlViscosity;
	NumberEdit *m_pctrlBeta;
	NumberEdit *m_pctrlPhi;
	...
	NumberEdit *m_pctrlMass, *m_pctrlCoGx,*m_pctrlCoGz, *m_pctrlIxx, *m_pctrlIyy, *m_pctrlIzz, *m_pctrlIxz;
