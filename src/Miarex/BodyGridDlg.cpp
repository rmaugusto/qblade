...
//	move(r.width()/3, r.height()/6);
	...
	m_pctrlUnit  = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlUnit->setValue(100);
	m_pctrlUnit2 = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlUnit2->setValue(101);
	m_pctrlMinUnit  = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlMinUnit->setValue(102);
	m_pctrlMinUnit2 = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlMinUnit2->setValue(103);
