/****************************************************************************
	...
	GL3dBodyDlg Class
	Copyright (C) 2009-10 Andre Deperrois adeperrois@xflr5.com
...
//	int r1 = geometry().width();
	...
	m_pctrlNXPanels = new NumberEdit;
	m_pctrlNHoopPanels = new NumberEdit;
	...
	m_pctrlNXPanels->setAutomaticPrecision(0);
	m_pctrlNHoopPanels->setAutomaticPrecision(0);
