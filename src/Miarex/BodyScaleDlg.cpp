...
//	move(r.width()/3, r.height()/6);
	...
	m_pctrlFrameID = new NumberEdit(NumberEdit::Standard, 0);
	m_pctrlFrameID->setValue(10);
	...
	m_pctrlXScaleFactor = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlXScaleFactor->setValue(1);
	m_pctrlYScaleFactor = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlYScaleFactor->setValue(2);
	m_pctrlZScaleFactor = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlZScaleFactor->setValue(3);
