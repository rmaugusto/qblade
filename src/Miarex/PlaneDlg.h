...
private:
	...
	NumberEdit  *m_pctrlXBody;
	NumberEdit  *m_pctrlZBody;
	NumberEdit  *m_pctrlXLEFin;
	NumberEdit  *m_pctrlYLEFin;
	NumberEdit  *m_pctrlZLEFin;
	NumberEdit  *m_pctrlZLEStab;
	NumberEdit  *m_pctrlXLEStab;
	NumberEdit  *m_pctrlXLEWing;
	NumberEdit  *m_pctrlZLEWing;
	NumberEdit  *m_pctrlXLEWing2;
	NumberEdit  *m_pctrlZLEWing2;
	NumberEdit  *m_pctrlStabTilt;
	NumberEdit  *m_pctrlFinTilt;
	NumberEdit  *m_pctrlWingTilt;
	NumberEdit  *m_pctrlWingTilt2;
