...
//	QSlider *m_pctrlAnimationSpeed, *m_pctrlAnimationAmplitude;
	...
	NumberEdit *m_pctrlModeStep;
	
	QLabel *m_pctrlStabLabel1, *m_pctrlStabLabel2, *m_pctrlStabLabel3;
	NumberEdit  *m_pctrlStabVar1, *m_pctrlStabVar2, *m_pctrlStabVar3;
	NumberEdit *m_pctrlTotalTime, *m_pctrlDeltat;
	...
	NumberEdit *m_pctrlFreqN, *m_pctrlFreq1, *m_pctrlDsi;
