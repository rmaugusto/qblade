...
void GL3DScales::SetupLayout()
{
	...
	QGroupBox *CpScaleBox = new QGroupBox(tr("Cp Scale"));
	{
		...
		m_pctrlLegendMin = new NumberEdit(NumberEdit::Standard, 2);
		m_pctrlLegendMin->setValue(61.234);
		m_pctrlLegendMax = new NumberEdit(NumberEdit::Standard, 2);
		m_pctrlLegendMax->setValue(3.5555);
...
//__________________________________	Streamlines
	...
	{
		m_pctrlNXPoint = new NumberEdit(NumberEdit::Standard, 0);
		m_pctrlNXPoint->setValue(33);
		m_pctrlDeltaL = new NumberEdit(NumberEdit::Standard, 2);
		m_pctrlDeltaL->setValue(12.34);
		m_pctrlXFactor = new NumberEdit(NumberEdit::Standard, 2);
		m_pctrlXFactor->setValue(1.23);
	...
	{
		m_pctrlXOffset = new NumberEdit(NumberEdit::Standard, 3);
		m_pctrlXOffset->setValue(4.56);
		m_pctrlZOffset = new NumberEdit(NumberEdit::Standard, 3);
		m_pctrlZOffset->setValue(7.89);
