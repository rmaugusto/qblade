...
//	MainFrame *pMainFrame = (MainFrame*)m_pMainFrame;
	...
	m_pctrlXTransFactor = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlYTransFactor = new NumberEdit(NumberEdit::Standard, 3);
	m_pctrlZTransFactor = new NumberEdit(NumberEdit::Standard, 3);
