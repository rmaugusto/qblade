...
protected:
	...
	NumberEdit *m_pctrlReMin, *m_pctrlReMax, *m_pctrlReDelta, *m_pctrlMach;
	NumberEdit *m_pctrlSpecMin, *m_pctrlSpecMax, *m_pctrlSpecDelta;
	NumberEdit *m_pctrlNCrit, *m_pctrlXTopTr, *m_pctrlXBotTr;
