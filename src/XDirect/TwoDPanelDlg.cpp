...
void TwoDPanelDlg::SetupLayout()
{
	...
	m_pctrlCVpar  = new NumberEdit;
	m_pctrlCTErat = new NumberEdit;
	m_pctrlCTRrat = new NumberEdit;
	m_pctrlXsRef1 = new NumberEdit;
	m_pctrlXsRef2 = new NumberEdit;
	m_pctrlXpRef1 = new NumberEdit;
	m_pctrlXpRef2 = new NumberEdit;
