...
private:
	...
	NumberEdit	*m_pctrlLEYHinge;
	NumberEdit	*m_pctrlLEXHinge;
	NumberEdit	*m_pctrlLEFlapAngle;
	NumberEdit	*m_pctrlTEYHinge;
	NumberEdit	*m_pctrlTEXHinge;
	NumberEdit	*m_pctrlTEFlapAngle;
