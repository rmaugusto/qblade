...
{
	m_pctrlGap->setMinimum(  0.0);
	m_pctrlGap->setMaximum(100.0);

	m_pctrlBlend->setMinimum(  0.0);
...
/*		for (int k=0; k<pXFoil->n;k++)
	...
	m_Gap = m_pctrlGap->getValue();
	m_Blend = m_pctrlBlend->getValue();
